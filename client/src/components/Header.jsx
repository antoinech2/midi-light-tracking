...
export default function Header({coords, hoverCoords, add, addAvailability, setPointing}){
    ...
    return (
        <Paper elevation={10}> 
            <Button variant="outlined" onClick={() => {ApiService.unselect(); setPointing(false);}} color="success">Unselect</Button>
